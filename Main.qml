...
Window {
    ...
    height: 600
    visible: true
    // visibility: Window.FullScreen // Bỏ comment khi chạy thật trên Pi 4 để kích hoạt toàn màn hình
    title: "MT Dashboard"
    color: "#13151a"
    ...
    // --- CẤU HÌNH BỘ ĐỊNH TUYẾN TỰ ĐỘNG (ROUTE MODEL) ---
    Plugin {
        id: mapPlugin
        name: "osm"
    ...
    RouteModel {
        ...
        // Tự động tính toán Quãng đường & Giờ đến ETA thực tế
        onStatusChanged: {
        ...
        // Định dạng thời gian di chuyển dự kiến
    ...
    // --- BỘ TÌM KIẾM TỌA ĐỘ THEO CHỮ (GEOCODE MODEL) ---
    GeocodeModel {
        id: geocodeModel
        plugin: mapPlugin
    ...
    Item {
        ...
        // --- CỘT PHẢI CO GIÃN THEO TỶ LỆ PHẦN TRĂM BIẾN THIÊN ---
        Column {
            anchors.left: leftCol.right; anchors.leftMargin: 12
            anchors.right: parent.right
            anchors.top: parent.top
            anchors.bottom: parent.bottom
            // Khoảng cách giữa Map và hàng Widgets bên dưới tự tính toán bằng 2% chiều cao màn hình
            spacing: parent.height * 0.02

            // KHUNG BẢN ĐỒ CHIẾM 58% CHIỀU CAO THỰC TẾ
            Rectangle {
                width: parent.width
                ...
                MapView {
                    ...
                    anchors.top: parent.top
                    anchors.bottom: parent.bottom
                    anchors.bottomMargin: -24 // Giấu chữ bản quyền chân trang
            ...
            // --- HÀNG DƯỚI CÙNG (CHIẾM 40% CHIỀU CAO THỰC TẾ): CO GIÃN THÔNG MINH KHÔNG LO BỊ MẤT CHỮ ---
            Row {
                width: parent.width
                ...
                Rectangle {
                    ...
                    Row {
                        anchors.top: parent.top
                        anchors.topMargin: parent.height * 0.07 // Co giãn biên lề theo tỷ lệ chiều cao mạch
                        anchors.left: parent.left
                        anchors.leftMargin: 16
                        spacing: 12
                ...
                // THẺ THỜI TIẾT TỶ LỆ VÀNG CHUẨN XÁC (Tự động thích ứng, ghim đáy cực kỳ sắc nét)
                Rectangle {
