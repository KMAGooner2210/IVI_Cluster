...
/* Giải phóng thiết bị CAN đúng cách khi tắt app, tránh rò rỉ bộ nhớ hệ thống */
...
void RealCanReceiver::connectCanDevice() {
    ...
    m_canDevice = QCanBus::instance()->createDevice(
        ...
        QStringLiteral("can0"), // Đổi thành "vcan0" nếu cần test giả lập SocketCAN trên máy Linux
        &errorString
    );
    ...
    /* Lắng nghe lỗi phần cứng bus để kích hoạt cơ chế reconnection */
